...
const DroneMap = ({ dronePositions }) => {
  ...
  return (
    <div className="bg-white p-6 rounded-lg border shadow-sm">
      <h3 className="text-lg font-semibold text-gray-900 mb-4">🗺️ Peta Drone - Desa Jenggawur</h3>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-4">
            <div className="flex items-center space-x-4">
              <h1 className="text-2xl font-bold text-gray-900">🌾 Smart Farm Desa Jenggawur</h1>
              <p className="text-sm text-gray-600 mt-1">Kabupaten Banjarnegara, Jawa Tengah</p>
